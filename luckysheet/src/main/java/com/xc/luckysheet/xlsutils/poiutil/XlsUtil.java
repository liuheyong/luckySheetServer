...
import com.xc.luckysheet.entity.enummodel.ExcelCenterStyleEnum;
    ...
    public static List<GridRecordDataModel> readExcel(Workbook workbook) {
        ...
        while (sheetIterator.hasNext()) {
            ...
            if (Objects.equals(0, sheetIndex)) {
                model = JfGridUpdateService.strToModel("", (sheetIndex + 1) + "", 1, sheetIndex);
            } else {
                model = JfGridUpdateService.strToModel("", (sheetIndex + 1) + "", 0, sheetIndex);
            }
            sheetIndex++;
            //读取sheet页
